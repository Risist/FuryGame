...
namespace El
{
	...
	SpiritWhite::SpiritWhite()
	{
	}

	void SpiritWhite::onInit()
	{
		Game::Object::onInit();
		...
		loadScript("model_spirit_white.txt", constructionScript, model_loaded);
	...
	void SpiritWhite::onUpdate(float dt)
	{
		Game::Object::onUpdate(dt);
		findAim();

	}
	void SpiritWhite::onDisplay(Camera& cam)
	{
